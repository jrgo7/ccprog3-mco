...
public final class CLIUtility {
    ...
    /***
     * Prints a prompt for the user to input an integer within a specified
     * range.
     * 
     * @param sc      The open {@link Scanner} object to read input from
     * @param message The message displayed to prompt the user
     ...
     * @param sc      The open {@link Scanner} object to read input from
     * @param message The message displayed to prompt the user
     * @return {@code true} if the user confirms, {@code false} if the user
     *         aborts
     */
    ...
    private CLIUtility() {
         ...
         * interface instead, as Java 8 onward allows default implementations
         * for static methods.
         */
    }
}